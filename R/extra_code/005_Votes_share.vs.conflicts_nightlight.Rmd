---
title: "PERCENT-VOTES VS. CONFLICTS + NIGHTLIGHT"
output: 
  html_notebook:
    theme: united
    toc: yes
...
share %>% as.data.frame()  %>% ggplot() + geom_histogram(aes(x=nightlight_mean,y=(..count..)/sum(..count..)),bins = 1+3.322*log10(nrow(share)/3),color="black",fill="red") + facet_wrap(~year,ncol=3)
...
```{r}
m <- model1_1 <- plm(votes_share ~ nightlight_mean +n.deaths,data=to.model,model="within",effect = "twoways")
...
pcdtest(votes_share ~ nightlight_mean +n.deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
...
plm::pwartest(votes_share ~ nightlight_mean +n.deaths,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +n.deaths,data=to.model,model="pooling")
...
m <- model1_2 <- plm(votes_share ~ nightlight_mean +log_n.deaths,data=to.model,model="within",effect = "twoways")
...
pcdtest(votes_share ~ nightlight_mean +log_n.deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
...
plm::pwartest(votes_share ~ nightlight_mean +log_n.deaths,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +log_n.deaths,data=to.model,model="pooling")
...
m <- model1_3 <- plm(votes_share ~ nightlight_mean +Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(votes_share ~ nightlight_mean +Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
Serial correlation test for short panels

```{r}

plm::pwartest(votes_share ~ nightlight_mean +Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model="pooling")
...
```{r}
m <- model1_4 <- plm(votes_share ~ nightlight_mean +n.conflicts,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(votes_share ~ nightlight_mean +n.conflicts,data=to.model,model = "within",effect="twoways",w = nb.matrix)
```
...
plm::pwartest(votes_share ~ nightlight_mean +n.conflicts,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +n.conflicts,data=to.model,model="pooling")
...
m <- model1_5 <- plm(votes_share ~ nightlight_mean +log_n.conflicts,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(votes_share ~ nightlight_mean +log_n.conflicts,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(votes_share ~ nightlight_mean +log_n.conflicts,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +log_n.conflicts,data=to.model,model="pooling")
...
m <- model1_6 <- plm(votes_share ~ nightlight_mean +Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(votes_share ~ nightlight_mean +Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(votes_share ~ nightlight_mean +Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model="pooling")
...
m <- model1_7 <- plm(votes_share ~ nightlight_mean +n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(votes_share ~ nightlight_mean +n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(votes_share ~ nightlight_mean +n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model)
...
```{r}
mpool <- plm::plm(votes_share ~ nightlight_mean +n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model="pooling")
...
out.file <- here::here("tables/votes_share.vs.conflicts_and_nightlights_models.html")
