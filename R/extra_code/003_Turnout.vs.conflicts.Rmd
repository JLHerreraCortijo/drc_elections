...
```{r}
here::i_am("R/003_Turnout.vs.conflicts.Rmd")
require(lmtest)
require(plm)
require(stargazer)
...
```{r}
m <- model1_1 <- plm(turnout ~n.deaths,data=to.model,model="within",effect = "twoways")
...
pcdtest(turnout ~n.deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
...
plm::pwartest(turnout ~n.deaths,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~n.deaths,data=to.model,model="pooling")
...
m <- model1_2 <- plm(turnout ~log_n.deaths,data=to.model,model="within",effect = "twoways")
...
pcdtest(turnout ~log_n.deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
...
plm::pwartest(turnout ~log_n.deaths,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~log_n.deaths,data=to.model,model="pooling")
...
m <- model1_3 <- plm(turnout ~Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(turnout ~Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(turnout ~Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~Non.state.vs.non.state_deaths + Foreign.vs.non.state_deaths + Non.state.vs.civilians_deaths + DRC.vs.non.state_deaths + DRC.vs.civilians_deaths +Foreign.vs.civilians_deaths,data=to.model,model="pooling")
...
```{r}
m <- model1_4 <- plm(turnout ~n.conflicts,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(turnout ~n.conflicts,data=to.model,model = "within",effect="twoways",w = nb.matrix)
```
...
plm::pwartest(turnout ~n.conflicts,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~n.conflicts,data=to.model,model="pooling")
...
m <- model1_5 <- plm(turnout ~log_n.conflicts,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(turnout ~log_n.conflicts,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(turnout ~log_n.conflicts,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~log_n.conflicts,data=to.model,model="pooling")
...
m <- model1_6 <- plm(turnout ~Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(turnout ~Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(turnout ~Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~Non.state.vs.non.state_events + Foreign.vs.non.state_events + Non.state.vs.civilians_events + DRC.vs.non.state_events + DRC.vs.civilians_events +Foreign.vs.civilians_events,data=to.model,model="pooling")
...
m <- model1_7 <- plm(turnout ~n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model="within",effect = "twoways")
...
```{r}
pcdtest(turnout ~n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model = "within",effect="twoways",w=nb.matrix)
```
...
plm::pwartest(turnout ~n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model)
...
```{r}
mpool <- plm::plm(turnout ~n.deaths_DRC_milit + n.deaths_foreign_milit +  n.deaths_non_state + n.deaths_civilians + n.deaths_unknow,data=to.model,model="pooling")
...
out.file <- here::here("tables/turnout.vs.conflicts_models.html")
